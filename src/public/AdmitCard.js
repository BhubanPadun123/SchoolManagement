...
import {useDownloadAdmitCardMutation} from "../Redux/actions/download.action"
import { useSelector, useDispatch } from "react-redux"
import _ from "lodash"
import { SearchOutlined } from "@mui/icons-material"

export default function PublicAdmitCard() {
    ...
    const [downloadAdminAction,downloadAdmitState] = useDownloadAdmitCardMutation()
        ...
        >
            ...
            >
                <CardContent>
                    ...
                    >
                        Enter your details below to view your examination admit card.
                    </Typography>
                    ...
                    <Box sx={{ display: "flex", flexDirection: "column", gap: 2 }}>
                        ...
                        <TextField
                            ...
                            onChange={(e) => {
                                ...
                                dispatch(updateFields({ password: password }))
                            }}
